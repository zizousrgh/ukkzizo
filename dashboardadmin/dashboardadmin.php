...
background: linear-gradient(90deg, rgba(66,82,255,1) 0%, rgba(254,171,62,1) 100%);          margin-top: 70px; /* Add margin-top to create space for the navbar */
...
<body>
    <a class="navbar-brand">
        <img src="../assets/  " alt="logo" width="100px">
    </a>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          ...
          <img src="../assets/buatakunpetugass.png" alt="daftar buku" style="max-width: 100%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
