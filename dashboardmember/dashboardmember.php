            ...
            <div class="d-flex flex-wrap justify-content-center gap-2">
                ...
                <div class="cardImg">
                    <a href="buku/detailpeminjaman.php">
                        <img src="../assets/peminjamanmember.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                    </a>
                </div>
                <div class="cardImg">
                    <a href="buku/koleksibuku.php">
                        <img src="../assets/koleksi.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                    </a>
                </div>
            </div>
        </div>
